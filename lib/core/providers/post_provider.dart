...
import 'package:rent_connect/features/auth/controller/post_update_controller.dart';
import 'package:rent_connect/features/auth/controller/search_post_controller.dart';
...
final managePostProviderController =
    AsyncNotifierProvider<ManagePostController, List<PostModel>>(
      ManagePostController.new,
    );
final postUpdateControllerProvider =
    AsyncNotifierProvider.family<PostUpdateController, PostModel, String>(
      PostUpdateController.new,
    );
//search
final searchPostControllerProvider = StateNotifierProvider<SearchPostController, AsyncValue<List<PostModel>>>((ref){
